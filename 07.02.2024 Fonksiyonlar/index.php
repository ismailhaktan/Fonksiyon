...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/degrade.jpg" alt=""></a>
        <figcaption>
          <h2>Uygulama 1</h2>
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/degrade2.jpg" alt=""></a>
        <figcaption>
          <h2>Uygulama 2</h2>
  ...
  <td>CVV</td>
    <td colspan='2'>2363</td>
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/degrade3.jpg" alt=""></a>
        <figcaption>
          <h2>Parametre Alan Fonksiyon</h2>
          <p>
            <?php
            //fonksiyon tanımlama
          function satranc($satir,$sutun){
            echo "<table width=4 height=4 border=1>";
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/degrade4.jpg" alt=""></a>
        <figcaption>
          <h2>Dolar Kuru</h2>
          <p>
            <?php
